...
namespace isDotServer
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //{
            //    options.UseSqlServer("Server=.;Database=isDotGame;User ID=sa;Password=Abcd@123456;TrustServerCertificate=True;Trusted_Connection=False;Connection Timeout=30;Integrated Security=False;Persist Security Info=False;Encrypt=True;MultipleActiveResultSets=True;", x => x.UseRowNumberForPaging());
            //});
            services.AddDbContext<Models.Context>(/*x => x.UseInMemoryDatabase()*/)
                ...
                .AddCustomRepository<Models.Payment, Models.PaymentRepository>();
        }
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            {
                routes.MapHub<Hubs.MainHub>("/mainhub");
            });
        }
    }
}
